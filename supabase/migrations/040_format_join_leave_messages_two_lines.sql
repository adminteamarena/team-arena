-- Format join/leave messages for two-line display
-- Format: "username 🎉 joined the match|Team A, Position 2" (using | as separator)
...
BEGIN
    ...
    chat_message := joiner_name || ' 🎉 joined the match|Team ' || NEW.team_side || ', Position ' || NEW.position_number;
