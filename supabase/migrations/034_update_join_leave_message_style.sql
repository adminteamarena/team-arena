-- Update join/leave message style to be more informative and clean
-- Remove emojis and make messages more neutral
...
BEGIN
    ...
    -- Create clean informative chat message for join
...
BEGIN
    ...
    -- Create clean informative chat message for leave
