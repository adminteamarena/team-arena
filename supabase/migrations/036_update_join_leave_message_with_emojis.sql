-- Update join/leave message format with emojis and team/position info
-- Format: "username 🎉 joined the match on Team A, Position 2" and "username 👋 left the match (Team A, Position 2)"
