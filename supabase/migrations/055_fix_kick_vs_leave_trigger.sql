-- Fix match leave trigger to distinguish between voluntary leaving and being kicked
-- This migration disables the trigger's notification logic since the kickParticipant function
-- in the application layer handles kick notifications properly

-- Simplified function that only handles chat messages and voluntary leave notifications
