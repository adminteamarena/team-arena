-- Improve join/leave message format with better wording
-- Format: "username just joined the match" and "username just left the match"
...
BEGIN
    ...
    -- Create improved informative chat message for join
    chat_message := joiner_name || ' just joined the match';
...
BEGIN
    ...
    -- Create improved informative chat message for leave
    chat_message := leaver_name || ' just left the match';
